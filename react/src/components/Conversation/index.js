...
const Conversation = ({ models, activeChatId, activeChat, messages }) => {
  ...
  useEffect(() => {
    if (scrollContainerRef2.current) {
      scrollContainerRef2.current.scrollTop =
        scrollContainerRef2.current.scrollHeight; // Scroll to the bottom
    }
  }, [messages]); // Run the effect whenever messages change
